...
%%% @end
%%%-------------------------------------------------------------------
-module(em_teltonika_protocol_SUITE).
...
parse_test(_Config) ->
  ...
  Res = em_teltonika_protocol:parse(<<"+RESP:GTSOS,123456789012345,0,0,0,1,0.0,0,0.0,1,130.000000,60.000000,20120101120300,0460,0000,18d8,6141,00,11F0,0102120204\0">>),
